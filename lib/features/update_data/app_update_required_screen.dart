...
class AppUpdateRequiredScreen extends StatelessWidget {
  const AppUpdateRequiredScreen(
      {super.key, required this.updateImpossible, required this.availableOffline});
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 16),
                child: Text(AppStrings.appUpdateHeader, style: Theme.of(context).t.h1),
              ),
              const SizedBox(height: 16),
              Text(
                AppStrings.appUpdateRequiredBody1,
                style: Theme.of(context).t.bodyMediumRegular,
              ),
              const SizedBox(height: 24),
              Text('${AppStrings.appUpdateRequiredBody2} $_store.',
                  style: Theme.of(context).t.bodyMediumRegular),
