...
class _ApiService implements ApiService {
  ...
  Future<List<ProblemModelApi>> getProblems() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProblemModelApi>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<InfoCategoryModelApi>> getInfoCategories() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<InfoCategoryModelApi>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<CityModelApi>> getCities() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CityModelApi>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
